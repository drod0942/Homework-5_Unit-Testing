...
const SongRatingForm = ({ setSongs }) => {
    ...
    const handleCreate = async () => {
        ...
        const response = await axios.post(`http://129.133.185.148/homework3/Controller/RestApi/Ratings/create-rating.php`, newSong);
        console.log(response.data);
        // fetching the new Song List
        const res = await axios.get(`http://129.133.185.148/homework3/Controller/RestApi/Ratings/Read_ratings.php`);
